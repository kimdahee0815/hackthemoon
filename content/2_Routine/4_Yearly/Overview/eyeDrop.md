...
//DataviewJS loop
for (let page of dv.pages('"content/2_Routine/1_Daily/Daily-Routine"').where(p => p.eyeDrop)) {
    ...
    calendarData.entries.push({
        ...
        content: await dv.span(`[](Calendar/Daily/Diary/${page.file.name})`),           // (optional) Add text to the date cell
